...
from utils.cow_utils.src.models.localization.clip_patch import ClipPatch
...
class AgentFbePatch(AgentFbe):
    ...
    def __init__(
        ...
        super(AgentFbePatch, self).__init__(fov=fov,
                                            device=device,
        ...
        self.clip_module = ClipPatch(clip_model_name, classes,
