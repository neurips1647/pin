...
from utils.cow_utils.src.models.localization.clip_owl import ClipOwl
from src.simulation.constants import (FORWARD_M, FOV, IMAGE_HEIGHT,
                                      IMAGE_WIDTH, IN_CSPACE,
...
class AgentMapLearnedOwl(AgentMapLearned):
    '''
    ...
    def __init__(
        ...
        super(AgentMapLearnedOwl, self).__init__(
        ...
        self.clip_module = ClipOwl(clip_model_name, classes,
...
def build(exploration_model_path, prompts_path, fail_stop, threshold, clip_model_name="ViT-B/32", device_num=-1, debug_dir=None, wandb_log=False, env_type=EnvTypes.ROBOTHOR, class_type=ClassTypes.REGULAR, center_only=False):
    ...
    agent_class = AgentMapLearnedOwl
    agent_kwargs = {
