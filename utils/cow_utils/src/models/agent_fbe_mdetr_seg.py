...
from utils.cow_utils.src.models.localization.mdetr_seg import MdetrSeg
...
class AgentFbeMdetrSeg(AgentFbe):
    '''
    ...
    def __init__(
        ...
        super(AgentFbeMdetrSeg, self).__init__(fov,
                                              device,
        ...
        self.clip_module = MdetrSeg(clip_model_name, classes, classes_clip,
