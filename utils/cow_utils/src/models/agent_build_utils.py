...
from utils.cow_utils.constants import HABITAT_PERSOBJECT_TYPES
from utils.cow_utils.src.simulation.constants import (
    AGENT_HEIGHT_HABITAT_M,
    AGENT_HEIGHT_THOR_M,
...
def get_env_class_vars(prompts_path, env_type, class_type):
    ...
    if env_type == EnvTypes.HABITAT:
        ...
        elif class_type == ClassTypes.PIN:
            classes = HABITAT_PERSOBJECT_TYPES
            classes_clip = HABITAT_PERSOBJECT_TYPES_CLIP
        ...
        if (
            ...
            or class_type == ClassTypes.SPATIAL
            or class_type == ClassTypes.APPEARENCE
            or class_type == ClassTypes.HIDDEN
        ):
