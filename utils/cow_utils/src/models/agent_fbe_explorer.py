...
from utils.cow_utils.src.models.localization.clip_filler import ClipFiller
...
class AgentFbeExplorer(AgentFbe):
    '''
    ...
    def __init__(
        ...
        super(AgentFbeExplorer, self).__init__(fov,
                                              device,
