...
class HabitatObjectNavEnv(HabitatEnv):
    """
    This class is a Habitat simulation environment for performing an Object Goal
    Navigation task (ObjectNav) using Home Robot APIs.
    ...
    def _preprocess_obs(
        ...
        task_observations = {"objectgoal": habitat_obs["objectgoal"]}
