...
from typing import Any, Dict, cast, Optional, TypeVar
...
class HabitatPINEnv(HabitatEnv):
    """
    This class is a Habitat simulation environment for performing Personalized Instance
    Navigation task (PIN) using Home Robot APIs.
    ...
    def _preprocess_obs(
        ...
        task_observations = {"pin_goal": habitat_obs["pin_goal"]}
        ...
        if "semantic" in habitat_obs:
            obs_dict["semantic"] = habitat_obs["semantic"]
        return obs_dict    
    ...
    def _preprocess_action(self, action: home_robot.core.interfaces.Action) -> int:
        ...
        return HabitatSimActions[discrete_action['action']]
