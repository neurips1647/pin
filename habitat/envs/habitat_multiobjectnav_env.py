...
class HabitatMultiObjectNavEnv(HabitatEnv):
    """
    This class is a Habitat simulation environment for performing an MultiObject Goal
    Navigation task (MultiON) using Home Robot APIs.
    """
    ...
    def _preprocess_obs(
        ...
        task_observations = {"multiobjectgoal": habitat_obs["multiobjectgoal"]}
