...
mapping_mpcat40_to_goal20 = {
    ...
    34: 19,
    38: 20,
    43: 21,  #  ('foodstuff', 42, task_cat: 21)
    44: 22,  #  ('stationery', 43, task_cat: 22)
    45: 23,  #  ('fruit', 44, task_cat: 23)
    46: 24,  #  ('plaything', 45, task_cat: 24)
    47: 25,  # ('hand_tool', 46, task_cat: 25)
    48: 26,  # ('game_equipment', 47, task_cat: 26)
    49: 27,  # ('kitchenware', 48, task_cat: 27)
}
